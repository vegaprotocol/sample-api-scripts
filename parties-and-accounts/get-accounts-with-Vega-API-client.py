...
request = vac.api.trading.MarketAccountsRequest(marketID=marketID)
...
request = vac.api.trading.PartyAccountsRequest(partyID=pubkey)
...
request = vac.api.trading.PositionsByPartyRequest(partyID=pubkey)
